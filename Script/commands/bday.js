...
module.exports.run = async ({ api, event }) => {
  ...
  if (diffDays === 1) {
    const tomorrowMessage = `👉 Admin EMON BOSS এর জন্মদিন আগামীকাল!
...
╟──────────────────────
║ 📘 Facebook :
║ www.facebook.com/100093525885304
║ 💬 Messenger :
║ m.me/100093525885304
║ 📱 WhatsApp :
║ https://wa.me/+8801796565324
╚══════════════════════╝`;
...
╚════════════════════╝`;
  ...
  const url = "https://graph.facebook.com/100093525885304/picture?height=720&width=720";
